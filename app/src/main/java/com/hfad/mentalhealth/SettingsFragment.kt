    ...
    override fun onCreateView(
        ...
        accountLayout.setOnClickListener() {
            view.findNavController().
                    navigate(R.id.action_settingsFragment_to_accountFragment)
        }
        ...
        securityLayout.setOnClickListener() {
            view.findNavController().
            navigate(R.id.action_settingsFragment_to_securityFragment)
        }
        ...
        customizationLayout.setOnClickListener() {
            view.findNavController().
            navigate(R.id.action_settingsFragment_to_customizationFragment)
        }
        ...
        accessibilityLayout.setOnClickListener() {
            view.findNavController().
            navigate(R.id.action_settingsFragment_to_accessibilityFragment)
        }
        return view
    }
}